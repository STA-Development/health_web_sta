...
import PcrIcon from '../base/header/icons/pcrIcon'
import AntibodyIcon from '../base/header/icons/antibodyIcon'
import RapidIcon from '../base/header/icons/rapidIcons'
import ExpressIcon from '../base/header/icons/expressIcon'
import VaccineIcon from '../base/header/icons/vaccineIcon'
