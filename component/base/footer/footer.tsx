    ...
    return (
        <div className="footer-wrapper">
            <div className="important-information">
                <h4 className="important-information__title">Important Information</h4>
                <p className='important-information__description'>The human immune system antibody response
                    ...
                    antibodies is variable.
                </p>
                    <p className="important-information__description">Studies of the antibody response to SARS-CoV-2 alsoknown as COVID-19 are limited as
                        ...
                        within 6 days after seroconversion.
                    </p>
                        <p className="important-information__description">Positive results for IgG, IgA and IgM antibodies againstSARS-CoV-2 are generally
