        ...
        <Card permissions>
          ...
          <div className="card__content card__content-info">
            ...
            <ol className="card__content-info__list">
              ...
              <li>
                Once permissions are granted, select “Return to Waiting Room” button to return back
                to your consultation.
              </li>
            </ol>
          </div>
          <button type="button" className="button card__button" onClick={handlePageRefresh}>
            Refresh
          </button>
        </Card>
      ) : (
        <Card permissions>
          ...
          <div className="card__content card__content_settings card__content-info">
            ...
            <ol className="card__content-info__list">
              ...
              <li>
                Under site settings, locate Permissions and select both Camera and Microphone.
              </li>
              <li>Make sure the browser is enabled to allow to ask for permissions</li>
              <li>
                If the permission window does not appear again, locate “FH Health” under blocked
                site listings and select “allow”.
              </li>
              <li>
                Once permissions are granted, select “Return to Waiting Room” button to continue
                your consultation.
              </li>
            </ol>
          </div>
          <button type="button" className="button card__button" onClick={showRefreshModalView}>
            Try Again
          </button>
        </Card>
      )}
